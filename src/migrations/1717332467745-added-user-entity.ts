...
export class addedUserEntity1717332467745 implements MigrationInterface {
    name = 'addedUserEntity1717332467745'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "messageType" character varying NOT NULL, "message" character varying NOT NULL, "taskId" uuid, "userId" uuid, CONSTRAINT "REL_7e8d7c49f218ebb14314fdb374" UNIQUE ("userId"), CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
